...
export function Hero() {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-zinc-200/70 bg-white/90 p-8 shadow-sm backdrop-blur md:p-12">
      ...
      <h1 className="reveal-delay-1 mt-4 max-w-3xl text-4xl font-semibold leading-tight text-zinc-900 md:text-6xl">
        {siteConfig.name}
      </h1>
